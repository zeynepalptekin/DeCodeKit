...
final class ka2 extends u72<Long> implements u92, jb2, RandomAccess {
    private static final ka2 g;
    private long[] e;
    private int f;

    static {
        ka2 ka2Var = new ka2(new long[0], 0);
        g = ka2Var;
        ka2Var.w();
    }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        ...
        System.arraycopy(ka2Var.e, 0, this.e, this.f, ka2Var.f);
        this.f = r32;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final u92 k(int r3) {
        if (r3 >= this.f) {
            return new ka2(Arrays.copyOf(this.e, r3), this.f);
        }
    ...
    public final boolean remove(Object obj) {
        c();
        for (int r1 = 0; r1 < this.f; r1++) {
            if (obj.equals(Long.valueOf(this.e[r1]))) {
                long[] jArr = this.e;
                System.arraycopy(jArr, r1 + 1, jArr, r1, (this.f - r1) - 1);
                this.f--;
                ((AbstractList) this).modCount++;
                return true;
            }
