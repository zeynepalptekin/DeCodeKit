...
public final class ew2 implements Parcelable.Creator<aw2> {
    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ aw2 createFromParcel(Parcel parcel) {
        ...
        return new aw2(strG, strG2);
    }

    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ aw2[] newArray(int r1) {
        return new aw2[r1];
    }
}
