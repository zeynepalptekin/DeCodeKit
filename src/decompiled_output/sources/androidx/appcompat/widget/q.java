...
public class q extends MultiAutoCompleteTextView implements b.i.p.d0 {
    ...
    public q(@androidx.annotation.h0 Context context, @androidx.annotation.i0 AttributeSet attributeSet) {
        this(context, attributeSet, a.b.autoCompleteTextViewStyle);
    }

    public q(@androidx.annotation.h0 Context context, @androidx.annotation.i0 AttributeSet attributeSet, int r5) throws Resources.NotFoundException, IllegalArgumentException {
