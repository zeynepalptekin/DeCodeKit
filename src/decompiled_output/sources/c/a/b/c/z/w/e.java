...
public final class e implements w {
    ...
    static final float f2120a = 0.35f;
    ...
    static class a implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            this.f2121a.setAlpha(v.l(this.f2122b, this.f2123c, this.d, this.e, ((Float) valueAnimator.getAnimatedValue()).floatValue()));
        }
    }
    ...
    public Animator a(@h0 ViewGroup viewGroup, @h0 View view) {
        return c(view, 0.0f, 1.0f, f2120a, 1.0f);
    }

    @Override // c.a.b.c.z.w.w
    @i0
    public Animator b(@h0 ViewGroup viewGroup, @h0 View view) {
        return c(view, 1.0f, 0.0f, 0.0f, f2120a);
    }
}
