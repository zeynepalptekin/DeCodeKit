...
class v {
    ...
    private static final RectF f2162a = new RectF();

    static class a implements o.c {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ RectF f2163a;
        ...
        public c.a.b.c.u.d a(@h0 c.a.b.c.u.d dVar) {
            return dVar instanceof c.a.b.c.u.m ? dVar : new c.a.b.c.u.m(dVar.a(this.f2163a) / this.f2163a.height());
        }
    }
    ...
    static class b implements d {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ RectF f2164a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ RectF f2165b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ float f2166c;
        ...
        @Override // c.a.b.c.z.w.v.d
        @h0
        public c.a.b.c.u.d a(@h0 c.a.b.c.u.d dVar, @h0 c.a.b.c.u.d dVar2) {
            return new c.a.b.c.u.a(v.l(dVar.a(this.f2164a), dVar2.a(this.f2165b), this.f2166c, this.d, this.e));
        }
    }
    ...
    static View e(View view, @androidx.annotation.w int r3) throws Resources.NotFoundException {
    ...
    static View f(View view, @androidx.annotation.w int r2) {
    ...
    static void o(TransitionSet transitionSet, @i0 Transition transition) {
        if (transition != null) {
            transitionSet.addTransition(transition);
        }
    }

    static void p(TransitionSet transitionSet, @i0 Transition transition) {
        if (transition != null) {
    ...
    private static int q(Canvas canvas, Rect rect, int r9) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            return canvas.saveLayerAlpha(f2162a, r9);
        }
        RectF rectF = f2162a;
