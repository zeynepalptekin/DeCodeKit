...
public final class j7 extends y5 {
    ...
    private final SSLSocketFactory f6419c;

    j7(b5 b5Var) {
        super(b5Var);
        this.f6419c = Build.VERSION.SDK_INT < 19 ? new ja() : null;
    }
    ...
    protected final HttpURLConnection q(URL url) throws IOException {
        URLConnection uRLConnectionOpenConnection = url.openConnection();
        if (!(uRLConnectionOpenConnection instanceof HttpURLConnection)) {
            throw new IOException("Failed to obtain HTTP connection");
        }
        SSLSocketFactory sSLSocketFactory = this.f6419c;
